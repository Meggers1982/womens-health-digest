...
**Output:** Email to REDACTED@example.com
...
Send the digest by email to **REDACTED@example.com** using the Gmail MCP tool (`mcp__33d9aea4-1651-4ebb-914e-c3bccc53c5c5__create_draft` or the send equivalent).
